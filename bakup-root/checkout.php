...
$query = "SELECT *
FROM product,cart
WHERE cart.CART_ProductID=$prodid  AND cart.CART_CartID='$cartid' AND CART_Buying_Status ='Unbought'";
...
to {
  ...
  transform: rotate(359deg);
    ...
    <link href="https://js.stripe.com/v3/fingerprinted/css/checkout-434021353a4c7b20e01dc849ce07d592.css" rel="stylesheet">
  </head>
  <body>
       ...
       <div class="details shadow">
         <div class="details__item">
           ...
           <div class="item__image">
             <img class="iphone" src="rex.png" alt="">
           </div>
...
<?php echo $row['PRODUCT_Name']; ?>
             ...
             <div class="item__price">
               MYR <?php echo $row['PRODUCT_Price']; ?>
             </div>
             <div class="item__quantity">
               Quantity: <?php echo $row['CART_Qty']; ?>
             </div>
             <div class="item__description">
                <?php echo $row['PRODUCT_Descriptions']; ?>
               <ul style="">
