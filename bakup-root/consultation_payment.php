             ...
             <table class='order-table'>
               <tbody>
                 <tr>
                   ...
                   <td>
                     <br> <span class='thin'>Virtual Beauty Consultation</span>
                     <br> 1 hour <br> <span class='thin small'> Time : <?php echo $consultationRow['SCHEDULE_Start']; ?> --- <?php echo $consultationRow['SCHEDULE_End']; ?> <br><br></span>
                   </td>
