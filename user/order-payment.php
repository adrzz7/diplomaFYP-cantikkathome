...
$totalpay = $_GET['total'];
 ...
 $query = "SELECT *
    FROM product,cart
    WHERE product.PRODUCT_ID =cart.CART_ProductID  AND cart.CART_CartID='$cartid' AND CART_Buying_Status ='Unbought' GROUP BY PRODUCT_ID";
...
.order-info {
  ...
  position:relative;
      ...
      .orderSum{ overflow-y: auto; height: 370px; padding-right: 15px; }
.price {
  bottom:0px;
  position:absolute;
  right:0px;
...
<nav class="bg-white">
    <div class="d-flex align-items-center">
       <div class="logo"> <a href="index.php"> <img src="picture/logo.png"  height="34"> </a></div>
        <div class="ml-auto"> <a href="Product.php" class="text-uppercase" style="font-family: Arial,serif;font-weight:bold; font-size: 1em; color: #4F3A83">Back to Shopping</a> </div>
    </div>
</nav>
<header>
