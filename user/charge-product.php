...
// mysqli_query($connect,"INSERT INTO orders (ORDERS_CartID  , ORDERS_Ordered_Date, ORDERS_Order_Status ,ORDERS_Tracking_No,ORDERS_Email_Status ) VALUES ( '$cartid', '$orderdate'  ,'Unprocessed','TXXX' ,'No' )") ;
 ...
 mysqli_query($connect,"INSERT INTO payment_order (  PAYMENT_ORDER_OrderID  , PAYMENT_ORDER_Payment_Date ,PAYMENT_ORDER_Status, PAYMENT_ORDER_Amount ) VALUES ( '$orderid', '$orderdate' ,'Approved','$totalpay'  )") ;
