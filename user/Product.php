...
<div>
    ...
    while($result = mysqli_fetch_assoc($data)){
        ...
        <div id="<?php echo $CATEGORIES_Name;?>" class="tabcontent">
            ...
            $sql1 = "SELECT * FROM product WHERE PRODUCT_CategoryID='$PRODUCT_CategoryID' AND PRODUCT_Status ='Available'";
    ...
    <section class="product">
        <div class="card" >
            ...
            while($result1 = mysqli_fetch_assoc($data1)){
                ...
                ?>
                <div  class="ProCard" value="<?php echo $prodid ?>" onclick="window.location.href='product-card.php?prodid=<?php echo "$prodid"  ?>'">
                    <div class="video-container">
                        <img src=data:image;base64,<?php echo $result1['PRODUCT_Images']; ?> width="180px" height="200px"/>
                    </div><hr>
