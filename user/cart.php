		    ...
		    <div class="row">
		        <div class="col-lg-6 col-md-8 col-sm-10 offset-lg-0 offset-md-2 offset-sm-1">
		            ...
		            <div id="details" class="bg-white rounded pb-5">
		                <form>
		                      <div class="form-group"> <label class="text-muted">Full Name</label>
		                        <div class="d-flex jusify-content-start align-items-center rounded p-2"> <input disabled type="email" value="<?php echo 	$custrow ['CUSTOMER_FirstName']; echo " " ; echo 	$custrow['CUSTOMER_LastName']; ?>"> <span class="fas fa-check text-success pr-sm-2 pr-0"></span> </div>
		                    </div>
		                    
		                    <div class="form-group"> <label class="text-muted">Email</label>
		                        <div class="d-flex jusify-content-start align-items-center rounded p-2"> <input disabled type="email" value="<?php echo 	$custrow ['CUSTOMER_Email']; ?>"> <span class="fas fa-check text-success pr-sm-2 pr-0"></span> </div>
		                    </div>
		                  <div class="form-group"> <label class="text-muted">Address</label>
		                        <div class="d-flex jusify-content-start align-items-center rounded p-2"> <input disabled type="email" value="<?php echo 	$custrow ['CUSTOMER_Address']; ?>"> <span class="fas fa-check text-success pr-sm-2 pr-0"></span> </div>
		                    </div>
		              <span > <b> Note : If you would like to change your address , please update your address in profile </b></span
		                </form>
		            </div> 
