...
require_once('..\vendor\autoload.php');
 ...
 $result =mysqli_query($connect, "INSERT INTO payment_consultation( PAYMENT_CONSULTATIONID   ,PAYMENT_CONSULTATION_Date,	PAYMENT_CONSULTATION_Status , PAYMENT_CONSULTATION_Amount  ) VALUES('$conid' ,'$currentdate' , 'Approved'  , '50.00'   ) ");
...
$data =$conid ."<br/>New Consultationn is Booked!";
