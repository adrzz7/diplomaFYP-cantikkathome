...
$bil=1;
      ...
      <tr >
        ...
        <td class="text-center">B<?php echo $row['BEAUTICIAN_ID']; ?>  </td>
          ...
          <td >
                 <button type="button" class="btn btn-info editbtn"  data-toggle="modal" data-target="#editModal<?php echo $result['BEAUTICIAN_ID']; ?>" name='editbtn' ><i class="far fa-edit"></button></td>
          </td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="../dbaction/AdminBeautician_Action.php" class="needs-validation" method="post" novalidate>
