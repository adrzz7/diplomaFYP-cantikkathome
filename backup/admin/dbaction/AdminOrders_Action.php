...
include_once 'cantikkathome\connect.php.php';
...
if (isset($_POST['update'])){
      ...
      $mail = new PHPMailer(true);
        ...
        // Content
          ...
          $mail->Body    = "<b> Your order is confirmed ! </b> <br/> Thanks for showing your support ❤. <br/><br/>Your goods are on the way to your doorsteps. <br/><br/>Here is Tracking No of your item $trackno.<br/><br/> Please click <a href=www.tracking.my/jt >here </a>  to check the status of your item. Thank you !";
