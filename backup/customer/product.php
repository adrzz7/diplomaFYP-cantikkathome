...
<header id="page-top">
    <div class="container">
        <div style="margin-bottom:0;">
            ...
            <img src="../assets/zzz.png" class="imageTuto" alt="">
        </div>
    </div>
</header>
                ...
                while($result1 = mysqli_fetch_assoc($data1)){
                    ...
                    <div>
                        <div class="video-container">
                            ...
                            <img src=data:image;base64,<?php echo $result1['PRODUCT_Images']; ?> width="100px" value="<?php echo $prodid ?>" onclick="window.location.href='product_view.php?id=<?php echo "$prodid"  ?>'"/>
                        </div>
    ...
    <section class="primary" id="contact">
        <div class="container">
            ...
            <div class="row">
                <div class="column">
                    <div>
                        <img src="../assets/tutoimg2.png" alt="Tutorial" class="tutoimg2">
                    </div>
                </div>
