		        ...
		        <div class="col-lg-6 col-md-8 col-sm-10 offset-lg-0 offset-md-2 offset-sm-1 pt-lg-0 pt-3">
		            <div id="cart" class="bg-white rounded">
		               ...
		               echo"<div class='d-flex jusitfy-content-between align-items-center pt-3 pb-2 border-bottom'>";
									 echo"<div class='d-flex jusitfy-content-between align-items-center pt-3 pb-2 border-bottom'>";
 								 echo"     <div class='item pr-2'> <img src='data:image;base64,".$row["PRODUCT_Images"]."'width='80' height='80'>";
		                 echo"        <div class='number'>".$row["CART_Qty"]."</div>";
		                echo"     </div>";
		                  echo"   <div class='d-flex flex-column px-3'> <b class='h5'>".$row['PRODUCT_Name']." </b>";
		                  echo"<a  class='h5 text-primary'>P-".$row['PRODUCT_ID'] ." </a> </div>";
		                echo"     <div class='ml-auto'> <b class='h5'>RM ".$row["PRODUCT_Price"]."</b> </div>";
...
$total = $total +($row["PRODUCT_Price"] *$row["CART_Qty"]  );
		            ...
		            <div class="row pt-lg-3 pt-2 buttons mb-sm-0 mb-2">
		                ...
		                <div class="col-md-6 pt-md-0 pt-3">
		                    <div class="btn text-white ml-auto"> <span class="fas fa-lock"></span> <a  style="color:white;" href="order_payment.php?CARTID=<?php echo "$cartid"; ?>&total=<?php echo "$total";?>">  CHECKOUT NOW </a> </div>
		                </div>
		            </div>
