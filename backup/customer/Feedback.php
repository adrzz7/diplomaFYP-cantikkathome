...
<section>
    <div class="FeedbackForm">
        <form action="FeedbackAction.php" method="POST" class="FeedbackForm">
            ...
            <div class="row">
                ...
                <div class="column">
                    ...
                    <div class="Center">
                        <input class="FeedBackFrmBtn" type="submit" name="AddFeedback" value="Submit">
                    </div>
